  ...
  return (
    <div className="max-w-6xl mx-auto flex flex-col h-[calc(100vh-140px)] md:h-[calc(100vh-80px)]">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-black uppercase tracking-tight text-zinc-950 md:text-3xl">Komentar</h1>
        ...
        <div className="relative w-full sm:w-72">
            ...
            <input 
              ...
              className="w-full rounded-full border border-zinc-200 bg-white py-3 pl-10 pr-4 text-xs text-zinc-950 placeholder:text-zinc-400 transition-colors focus:border-brand-cyan focus:outline-none"
            />
        </div>
      </div>

      <div className="flex flex-1 flex-col overflow-hidden rounded-3xl border border-zinc-200 bg-white">
          <div className="flex-1 overflow-y-auto custom-scrollbar p-2 md:p-4">
              <div className="flex flex-col gap-3">
                  {filteredComments.length === 0 ? (
                      ...
                      <div key={comment.id} className="group flex flex-col gap-4 rounded-2xl border border-zinc-200 bg-white p-4 transition-all hover:border-zinc-950 lg:flex-row lg:items-center">
                          ...
                          <div className="flex items-center gap-4 flex-none lg:w-[250px] overflow-hidden">
                             ...
                             <div className="min-w-0">
                                 <p className="truncate text-sm font-bold text-zinc-950">{comment.userName}</p>
                          ...
                          <div className="flex-1 min-w-0">
                              <p className="border-l-2 border-brand-accent/30 pl-3 text-sm italic text-zinc-600">"{comment.content}"</p>
                          </div>

                          <div className="mt-2 flex flex-none items-center justify-between gap-2 border-t border-zinc-200 pt-3 lg:mt-0 lg:w-[250px] lg:border-t-0 lg:pt-0">
